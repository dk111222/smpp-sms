...
-- 数据导出被取消选择。
-- 导出  表 s_send.input_await 结构
CREATE TABLE `input_await` (
  `Id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键自增',
  `UUID` varchar(128) DEFAULT NULL,
  `Msg_Batch_No` varchar(50) DEFAULT NULL COMMENT '唯一标识',
  `Enterprise_Msg_Id` varchar(2000) DEFAULT NULL COMMENT '下游的msgId',
  ...
  `Content` varchar(2000) CHARACTER SET utf8mb4 NOT NULL COMMENT '短消息',
  `Charset` varchar(32) DEFAULT NULL COMMENT '编码',
  `Phone_Nos` text NOT NULL COMMENT '手机号码，多个用|分割  最后一位必须是|',
  `Phone_Nos_Count` int(11) DEFAULT NULL COMMENT '手机号码个数',
  `Protocol_Type_Code` varchar(128) NOT NULL COMMENT 'Web,Cmpp,HttpXml,HttpJson',
  `Country_Code` varchar(128) DEFAULT NULL COMMENT '国家代码',
  `Source_IP` varchar(56) NOT NULL COMMENT '提交短信的IP',
  ...
  KEY `uuid` (`UUID`) USING BTREE,
  KEY `Assist_Audit_Key` (`Assist_Audit_Key`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='等待发送用户提交的原始数据';
...
CREATE TABLE IF NOT EXISTS `report_await` (
    `Id` bigint NOT NULL AUTO_INCREMENT,
    `Msg_Batch_No` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '唯一标识',
    `Enterprise_Msg_Id` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '下游的msgId',
    `Channel_Msg_Id` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '通道msgid',
    `Product_No` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '产品编号',
    `Product_Channel_Id` int DEFAULT NULL COMMENT '产品通道id',
    `Group_Code` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '分组编号',
    `Priority_Level` int DEFAULT NULL COMMENT '优先级',
    `SP_Number` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '通道的SP号码',
    `Country_Code` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
    `Phone_No` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '接受短信手机号',
    `Channel_No` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
    `Sub_Code` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
    `Input_Sub_Code` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
    `Enterprise_No` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
    `Agent_No` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
    `Enterprise_User_Id` int DEFAULT NULL COMMENT '用户标识',
    `Enterprise_User_Unit_Price` decimal(12,6) DEFAULT NULL COMMENT '企业用户单价',
    `Agent_Unit_Price` decimal(12,6) DEFAULT NULL COMMENT '代理商单价',
    `Business_User_Id` int DEFAULT NULL COMMENT '业务员Id',
    `Operator` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '运营商：cmp：移动    sgi：联通    smg：电信      未知：Unkown',
    `Country_Number` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '国家编号',
    `MCC` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '移动国家码',
    `MNC` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '移动网络码',
    `Area_Name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '地域',
    `Province_Code` varchar(21) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '省份代码，0311,010省会的电话区号',
    `Message_Type_Code` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '消息类型',
    `Content` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '短消息',
    `Data_Status_Code` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0' COMMENT '数据状态：0：正常数据 1：重发的数据 2：第一次发送失败的数据',
    `Is_Show` bit(1) DEFAULT NULL COMMENT '是否显示',
    `Is_Deduct` bit(1) DEFAULT NULL COMMENT '是否是扣量：true：是 false:否',
    `Charset` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '编码',
    `Signature` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '签名',
    `Content_Length` int DEFAULT NULL COMMENT '短信字数',
    `Sequence` int DEFAULT NULL COMMENT '长短信的序列',
    `Protocol_Type_Code` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'Web,Cmpp,HttpXml,HttpJson',
    `Status_Code` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '状态，要自己定义:成功 Success，失败 Faild',
    `Sender_Local_IP` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发送器IP',
    `Sender_Local_Port` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发送器本地端口',
    `Gate_Ip` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '网关IP',
    `Native_Status` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '原生状态',
    `Status_Date` datetime DEFAULT NULL COMMENT '状态时间',
    `Submit_Status_Code` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '提交状态:成功 Success，失败 Faild',
    `Submit_Description` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '提交描述',
    `Submit_Date` datetime(3) NOT NULL COMMENT '网关提交时间',
    `Submit_Response_Date` datetime DEFAULT NULL COMMENT '提交响应时间',
    `Input_Log_Date` datetime(3) DEFAULT NULL COMMENT '在InputLog表中的创建时间',
