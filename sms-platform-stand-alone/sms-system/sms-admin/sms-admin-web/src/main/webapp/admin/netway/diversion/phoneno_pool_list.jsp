		...
		<div class="layui-col-md12">
			<div class="layui-card">
				<form class="layui-form layui-card-header layuiadmin-card-header-auto" onsubmit="return false;">
					<input value="<c:out value="${channelNo}"></c:out>" name="channel_No" id="channelNo" type="hidden" />
...
<script>
	layui.extend({tableExt: '/layuiadmin/extends/tableExt'}).use(['tableExt'], function () {
		...
		table.render({
			url: '/admin/channelDiversionPhoneNoPoolList',
			where: {
				"channel_No":'<c:out value="${channelNo}"></c:out>'
			},
			cols: [[
				{checkbox: true},
