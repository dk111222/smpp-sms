...
<form class="layui-form" action="/admin/netway_editChannelParameters" lay-filter="form" onsubmit="return false;"
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">语音模板ID</label>
        <div class="layui-input-inline"  style="width: 300px">
            <input type="text" maxlength="128" name="voice_template_code" autocomplete="off"  value="<c:out value="${reMap['voice_template_code'].value}"/>"    class="layui-input">
        </div>
        <label class="layui-form-label"></label>
            <div class="layui-input-inline"  style="width: 300px">
        </div>
