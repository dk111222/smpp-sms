        ...
        <div class="layui-card" style="padding: 10px 20px 10px 20px;">
            <fieldset class="layui-elem-field">
                ...
                <table class="layui-table" lay-filter="table">
                    ...
                    <tbody>
                    <td>
                        <c:out value="${details.messageTypeName}"/>/<c:out value="${details.submit.content_Length}字"/>/<c:if test="${details.isLMSName == '否'}">短/<c:out value="${details.submit.sequence}"/>条
                    </c:if><c:if test="${details.isLMSName == '是'}">长/第<c:out value="${details.submit.sequence}"/>条
                    </c:if>
                    </td>
