...
<body>
<form class="layui-form" action="/admin/set_agentDomain" lay-filter="form" onsubmit="return false;"
         ...
         <div class="layui-form-item">
             ...
             <div class="layui-input-inline">
                 <input type="text" maxlength="128" name="domain"  lay-verType="tips"
                        autocomplete="off" class="layui-input" value="<c:out value="${agent.domain}"/>">
             </div>
         </div>
         <div class="layui-form-item">
             ...
             <div class="layui-input-inline">
                 <input type="text" maxlength="128" name="login_Url"  lay-verType="tips"
                        autocomplete="off" class="layui-input" value="<c:out value="${agent.login_Url}"/>">
             </div>
         </div>
