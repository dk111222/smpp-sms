...
<body>
<form class="layui-form" action="/admin/agent_addAgentFee" lay-filter="form" onsubmit="return false;"
      style="padding: 20px 30px 0 0;">
    <input name="agent_No" id="subAgentNo" lay-verify="required" type="hidden" />
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 60%">
            <input name="unit_Price" type="number" step="0.0001" min="0" max="99999999.9999"  oninput="value=value.replace('-')" lay-Verify="required" class="layui-input layui-input-sm"/>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    window.onload = function () {
        var agentNo = $(window.parent.document).find("#agentNo").val();
        $("#subAgentNo").val(agentNo);
    }
