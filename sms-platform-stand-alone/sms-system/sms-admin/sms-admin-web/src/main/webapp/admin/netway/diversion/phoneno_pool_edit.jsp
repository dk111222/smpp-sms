...
<body>
<form class="layui-form" action="/admin/channelDiversionPhoneNoPoolEditSave" lay-filter="form" onsubmit="return false;"
	style="padding: 20px 30px 0 0;">
     <input name="id" id="id" type="hidden" value='<c:out value="${channelsDiversion.id }"></c:out>'/>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 200px">
            <ht:herocodeselect sortCode="state" name="status_Code" selected="${channelsDiversion.status_Code}" layVerify="required"/>
        </div>
    </div>
...
<script type="text/javascript">
    var strategy_Rule = ${channelsDiversion.strategy_Rule};
