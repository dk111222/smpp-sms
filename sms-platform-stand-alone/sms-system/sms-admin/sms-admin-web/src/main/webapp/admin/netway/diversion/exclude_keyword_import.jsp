...
<body>
<form class="layui-form" id="importFileForm" action="/admin/importChannelExcludeKeyword" lay-filter="form"
      enctype="multipart/form-data" method="post" style="padding: 20px 30px 0 0;" onsubmit="return fileFormSubmit();">
    <input name="channel_No" id="channelNo" type="hidden" />
...
<script type="text/javascript">
    function setValue(){
        var channel_No = $(window.parent.document).find("#channelNo").val();
        $("#channelNo").val(channel_No);
    }
