...
public interface IChargeManage {
	 ...
	 * @param charge
	 */
	void agentChargeUser(Agent loginAgent, AgentEnterpriseUserCharge charge);
	 ...
	 * @param exportFile
	 */
	void exportAgentEnterpriseUserChargeList(String path, AgentEnterpriseUserChargeExt charge, ExportFileExt exportFile,String exportType);
	 ...
	 * @return
	 */
	List<Map<String, Object>> getAgentEnterpriseUserChargeListForExport(AgentEnterpriseUserChargeExt charge);
	 ...
	 * @return
	 */
	List<AgentEnterpriseUserCharge> queryAgentEnterpriseUserChargeList(AgentEnterpriseUserChargeExt charge);
	 ...
	 * @param exportType
	 */
	void exportAgentChargeOrderList(String path, AgentChargeExt agentChargeExt, ExportFileExt exportFile,
									String exportType);
	 ...
	 * @return
	 */
	List<Map<String, Object>> getAgentChargeOrderListForExport(AgentChargeExt agentChargeExt);
