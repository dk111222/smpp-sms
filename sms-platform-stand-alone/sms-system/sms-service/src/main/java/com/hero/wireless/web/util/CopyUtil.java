...
public class CopyUtil {
    ...
    public static final BeanCopier INPUT_INPUTAWAIT_COPIER = BeanCopier.create(Input.class, InputAwait.class, false);
    ...
    public static final BeanCopier REPORT_REPORTAWAIT_COPIER = BeanCopier.create(Report.class, ReportAwait.class, false);

    public static final BeanCopier REPORTAWAIT_REPORT_COPIER = BeanCopier.create(ReportAwait.class, Report.class, false);
}
