...
public class HttpClient {
	 ...
	 * 最多排队请求数
	 */
	public final static int MAX_QUEUE_COUNT = 100;
	...
	public void getAsync(String url, Map<String, String> params, Callback callback) {
		try {
			...
			//限制等待队列
			while (OK_HTTP_CLINET.dispatcher().queuedCallsCount() > MAX_QUEUE_COUNT) {
	...
	public static int getWaitCount() {
		//开始OK_HTTP_CLINET未初始化
		if (OK_HTTP_CLINET == null) {
			return 0;
		}
		return OK_HTTP_CLINET.dispatcher().queuedCallsCount();
	}
