  ...
  layui.extend({tableExt: '/js/layui-ext/tableExt'}).use(['tableExt'], function () {
    ...
    table.render({
      ...
      , cols: [[
        ...
        {title: '手机号',width: 160,templet:function (d) {
            return handleData(d.phone_Nos);
          }},
        {title: '批次号',width: 200,templet:function (d) {
                var a = handleData(d.msg_Batch_No);
                if(limitTypeInput == '006012002'){
                    a = "<a href='javascript:;' lay-event='{\"type\":\"tagTodo\",\"url\":\"/admin/sended_reportIndex?limitCode=006012002&flag=Input_Log_Flag&minCreateDate="+d.create_Date+"&msg_Batch_No="+d.msg_Batch_No+"\",\"title\":\"详情\"}' style='color: #01aaed;text-decoration-line: underline;'>"+handleData(d.msg_Batch_No)+"</a>";
                }
                return a;
          }},
