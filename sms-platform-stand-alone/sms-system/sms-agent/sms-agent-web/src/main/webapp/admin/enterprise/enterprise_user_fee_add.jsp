...
<form class="layui-form" action="/admin/enterprise_addEnterpriseUserFee" lay-filter="form" onsubmit="return false;"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 60%">
            <input  type="number" step="0.0001" min="0" max="99999999.9999" oninput="value=value.replace('-')" name="unit_Price" lay-verify="required" class="layui-input layui-input-sm"/>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label" style="width: 20%">税点</label>
        <div class="layui-input-inline" style="width: 60%">
            <input  type="number" step="0.0001" min="0" max="99999999.9999" oninput="value=value.replace('-')" name="tax_Point" class="layui-input layui-input-sm"/>
        </div>
    </div>
    <div class="layui-form-item">
