        ...
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item  layui-show-xs-inline-block" lay-unselect>
                    <a href="javascript:;">
                        <cite>
                            <c:out value="${AGENT_INFO.user_Name}"/>
                            <c:set var="code"><ht:heropageconfigurationtext code="switch_agent_user_name" defaultValue="请设置信息"/></c:set>
                            <c:if test="${code eq 'on'}">
                                (<c:out value="${AGENT_INFO.name}"/>)
                            </c:if>
                        </cite>
                    </a>
                    <dl class="layui-nav-child ">
                        ...
                        <hr>
                        <dd layadmin-event="logout" style="text-align: center;"><a href="/admin/agent_Logout">退出</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
        ...
        <div class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    ...
                    <c:forEach items="${AGENT_INFO.limits}" var="i" varStatus="st">
