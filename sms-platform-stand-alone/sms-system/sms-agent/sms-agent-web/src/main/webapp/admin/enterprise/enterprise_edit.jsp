...
<form class="layui-form" id="layui-form" action="/admin/enterprise_edit" lay-filter="form" onsubmit="return false;"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" maxlength="64" name="email" value="<c:out value="${eBean.email}"/>" placeholder="请输入" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea type="text" maxlength="2048" name="remark" autocomplete="off" class="layui-textarea"><c:out value="${eBean.remark}"/></textarea>
        </div>
    </div>
