						...
						<tr>
							...
							<td class="layui-inline">
								...
								<td class="layui-inline" style="width: 100px">
									<ht:herocodeselect name="status" sortCode="003" /></td>
							</td>
							<td class="layui-inline">&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td class="layui-inline">
	...
	layui.extend({tableExt: '/js/layui-ext/tableExt'}).use(['tableExt'], function () {
		...
		table.render({
			...
			,cols: [[
				...
				,{title: '企业名称', width:150,templet:function (d) {
	 ...
	 //接入信息详情
    function cmppDetail(userName,password,enterprise_No,http_Sign_Key,tcp_User_Name,cmppSubmitSpeed,cmppMaxChannel) {
        var area = $("#areaId");//初始值
        ...
        area.append("\n");
        area.append("速度："+(cmppSubmitSpeed!='null'?cmppSubmitSpeed:200));
        area.append("\n");
        area.append("连接数："+(cmppMaxChannel!='null'?cmppMaxChannel:3));
		area.append("\n");
